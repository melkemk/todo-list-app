...
const AboutPage: React.FC = () => {
    ...
    const { description, responsibilities, idealCandidate, categories, startDate, endDate, deadline, location, requiredSkills, whenAndWhere, datePosted } = job;
                        ...
                        <div>
                            <div className="flex">
                                ...
                                <div>
                                    ...
                                    <p className="font-epilogue text-base font-normal leading-[25.6px] text-[rgba(81,91,111,1)]">{new Date(datePosted).toLocaleDateString()}</p>
                                </div>
                            </div>
                            <div className="flex">
                                ...
                                <div>
                                    ...
                                    <p className="font-epilogue text-base font-normal leading-[25.6px] text-[rgba(81,91,111,1)]">{new Date(deadline).toLocaleDateString()}</p>
                                </div>
                            </div>
                            <div className="flex">
                                ...
                                <div>
                                    ...
                                    <p className="font-epilogue text-base font-normal leading-[25.6px] text-[rgba(81,91,111,1)]">{location.join(', ')}</p>
                                </div>
                            </div>
                            <div className="flex">
                                ...
                                <div>
                                    ...
                                    <p className="font-epilogue text-base font-normal leading-[25.6px] text-[rgba(81,91,111,1)]">{new Date(startDate).toLocaleDateString()}</p>
                                </div>
                            </div>
                            <div className="flex">
                                <MdOutlineEventNote className={iconClasses} />
                                <div>
                                    ...
                                    <p className="font-epilogue text-base font-normal leading-[25.6px] text-[rgba(81,91,111,1)]">{new Date(endDate).toLocaleDateString()}</p>
                                </div>
                            </div>
                        </div>
                        {/* Categories Section */}
